...
FILMS = [
    ...
    {"title": "The End of Oak Street", "release": "2026-08-14", "point": 17.0, "bayes": 17.2,
     "lo": 10.7, "upside": 29.7, "p_large": 0.0, "tier": "MID",
     "note": "V31 V3 @ D-7 (refined read, 08-07). Warner Bros./Bad Robot original sci-fi thriller (David Robert Mitchell), retitled from Flowervale Street, starring Anne Hathaway and Ewan McGregor; PG-13. Mid-tier demand (Google Trends ~49th pctile) against an $85M production budget keeps meaningful downside risk: best-estimate MID $17.0M, risk-adjusted $17.2M, 50% HDR $10.7M-$29.7M. Tightened from the $22.3M D-14 read as the D-7 cohort re-ranks demand."},
