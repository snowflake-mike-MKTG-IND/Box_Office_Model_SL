...
FILMS = [
    ...
    {"title": "Spider-Man: Brand New Day", "release": "2026-07-31", "point": 114.9, "bayes": 89.9,
     "lo": 65.9, "upside": 157.7, "p_large": 0.99, "tier": "LARGE+",
     "note": "V31 @ D-14 (re-scored 07-17 on fresh trends). Mega-tentpole with a wide, right-skewed distribution; demand-forward flag near-certain (99%). Best-estimate $114.9M, risk-adjusted ~$90M, upside ~$158M. Notably more conservative than the earlier V30 read ($149.6M) — pedigree-gating tempers hype toward demand-confirmed levels."},
    ...
    {"title": "Super Troopers 3", "release": "2026-08-07", "point": 6.9, "bayes": 6.5,
     "lo": 4.7, "upside": 11.6, "p_large": 0.0, "tier": "SMALL",
     "note": "V31 @ D-21 early read. Broken Lizard comedy sequel (Searchlight); predecessor Super Troopers 2 opened to $15.2M. Low pre-release Google Trends demand at D-21 → SMALL; sharpens as the launch window fills in."},
    {"title": "One Night Only", "release": "2026-08-07", "point": 5.0, "bayes": 4.8,
     "lo": 3.2, "upside": 9.7, "p_large": 0.0, "tier": "SMALL",
     "note": "V31 @ D-21 early read. Universal original rom-com (Will Gluck, Barbaro/Turner). Modest pre-release demand at D-21 → SMALL; re-score at a tighter horizon to refine."},
    {"title": "The Third Parent", "release": "2026-08-07", "point": 2.0, "bayes": 2.2,
     "lo": 0.5, "upside": 9.1, "p_large": 0.0, "tier": "SMALL",
     "note": "V31 @ D-21 early read. Bleecker Street horror adapted from Elias Witherow's viral creepypasta. Near-zero pre-release GT/YouTube signal at D-21 → low SMALL; monitor as marketing ramps toward release."},
]
