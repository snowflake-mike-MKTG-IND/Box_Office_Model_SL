...
FILMS = [
    ...
    {"title": "The Dog Stars", "release": "2026-08-28", "point": 13.8, "bayes": 14.2,
     "lo": 8.6, "upside": 24.6, "p_large": 0.0, "tier": "SMALL",
     "note": "V31 V3 @ D-3 (final pre-release). 20th Century sci-fi survival drama (Josh Brolin, Jacob Elordi), adapted from Peter Heller's 2012 novel (tier-2 book IP). Best-estimate SMALL $13.8M, risk-adjusted $14.2M, 50% HDR $8.6M-$24.6M — up from the D-14 read ($10.3M) on a firming demand ramp (mid-pack Google Trends + Wikipedia). Against a $110M budget this remains a steep downside story: mid-pack demand does not confirm the tentpole pedigree, so the gated model holds it SMALL."},
    ...
    {"title": "Finding Emily", "release": "2026-08-28", "point": 5.2, "bayes": 5.3,
     "lo": 3.0, "upside": 10.0, "p_large": 0.0, "tier": "SMALL",
     "note": "V31 V3 @ D-3 (final pre-release). Focus Features / Working Title romance (PG-13). Bottom-decile pre-release demand (Google Trends + Wikipedia) → SMALL $5.2M, risk-adjusted $5.3M, 50% HDR $3.0M-$10.0M."},
